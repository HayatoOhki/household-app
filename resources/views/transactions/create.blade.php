...
@section('content')
    @php
        $isTransactionDuplicate = $duplicateTransaction !== null;
        $isTransferDuplicate = $duplicateTransfer !== null;
        $isDuplicate = $isTransactionDuplicate || $isTransferDuplicate;
            ...
            $isTransferDuplicate
                ...
                : (
                    $isTransactionDuplicate
                        ? $duplicateTransaction->type->value
        ...
        $defaultAccountId = old(
            'account_id',
            $isTransactionDuplicate
                ? $duplicateTransaction->account_id
                : ''
        );
        ...
        $defaultCounterparty = old(
            'counterparty_name',
            $isTransactionDuplicate
                ? $duplicateTransaction->counterparty_name
                : ''
        );
        ...
        $defaultAmount = old(
            'amount',
            $isTransferDuplicate
                ? $duplicateTransfer->fromTransaction->amount
                : (
                    $isTransactionDuplicate
        ...
        $defaultExpenseRatio = old(
            'expense_ratio',
            $isTransactionDuplicate
                ? $duplicateTransaction->expense_ratio
                : 0
        );
        ...
        $defaultFromAccountId = old(
            'from_account_id',
            $isTransferDuplicate
                ? $duplicateTransfer->fromTransaction->account_id
                : ''
        );
        ...
        $defaultToAccountId = old(
            'to_account_id',
            $isTransferDuplicate
                ? $duplicateTransfer->toTransaction->account_id
                : ''
        );
    @endphp
